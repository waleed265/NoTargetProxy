...
newman run $GITHUB_WORKSPACE/apigee-cicd-master/test/integration/$NEWMAN_TARGET_URL -r htmlextra --reporter-htmlextra-export ./newman_report.html --env-var client_id=$id --env-var client_secret=$secret
#cat env.json
